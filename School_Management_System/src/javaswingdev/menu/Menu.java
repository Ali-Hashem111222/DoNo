...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        addTitle("السجلات"); // Appointments
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ACCESS_TIME, "المعلمين"));      
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PEOPLE, "الطلاب"));
        
        addTitle("تقارير"); // Prescriptoins
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.REPORT, "التقارير", "تقارير الطلاب", "تقارير المعلمين"));
        
        addTitle("الإدارة"); // Users
