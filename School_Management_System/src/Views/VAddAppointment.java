 ...
 * @author ITS
 */
public class VAddAppointment extends javax.swing.JDialog {
     ...
     */
    public VAddAppointment(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void init() {
        ...
        spTime.setValue(new java.util.Date());  // الوقت الحالي
    ...
    private void initComponents() {
        ...
        btnAddPatient = new com.raven.swing.Button();
        ...
        lblTitle.setText("إضافة موعد");

        btnAddPatient.setBackground(new java.awt.Color(51, 51, 51));
        btnAddPatient.setForeground(new java.awt.Color(255, 255, 255));
        btnAddPatient.setText("إضافة");
        btnAddPatient.setFont(new java.awt.Font("Simplified Arabic", 1, 14)); // NOI18N
        ...
        jLayeredPane1.setLayer(btnAddPatient, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        jLayeredPane1Layout.setHorizontalGroup(
            ...
            .addGroup(jLayeredPane1Layout.createSequentialGroup()
                .addGap(274, 274, 274)
                .addComponent(btnAddPatient, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLayeredPane1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jLayeredPane1Layout.createSequentialGroup()
                ...
                .addGap(43, 43, 43)
                .addComponent(btnAddPatient, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(25, 25, 25))
        );
    ...
    private void btnAddPatientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddPatientActionPerformed
        ...
        if (!cboxNamePatient.getSelectedItem().toString().trim().isEmpty()) {
            if (!cboxNameDoctor.getSelectedItem().toString().trim().isEmpty()) {
                ...
                try {
                appointment.insert(mAppointment);
                message.setLblTitle("يجب تمت الإضافة بنجاح");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAddAppointment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            VAddAppointment dialog = new VAddAppointment(new javax.swing.JFrame(), true);
            dialog.setVisible(true);
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private com.raven.swing.Button btnAddPatient;
